...
export default function BrandPanel({ eyebrow, title, description }) {
  return (
    <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-plum-950 p-10 text-gold-400 md:flex">
      ...
      <p className="relative text-xs text-gold-400/50">
        محافظت‌شده با رمزنگاری JWT و نشست امن
      </p>
    </div>
  );
}
